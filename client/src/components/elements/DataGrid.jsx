...
class DataGrid extends Component {
  ...
  handleSelectAllClick(event) {
    if (event.target.checked) {
      const newSelecteds = this.props.rows.map((n) => n.datasetName);
  ...
  render() {
    ...
    const [orderBy, setOrderBy] = React.useState('datasetDate');
      ...
      <div>
        ...
        <TableContainer>
          ...
          >
            ...
            />
            <TableBody>
              {stableSort(this.props.rows, getComparator(order, orderBy))
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.fieldsiteName}</TableCell>
