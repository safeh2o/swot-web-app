	...
	return (
		...
		>
			<path
				id="XMLID_19_"
				fill="#E9E9E0"
				d="M25.8,1.8H7c-0.5,0-0.9,0.4-0.9,1.2v24.1h27.9V10.3c0-0.5-0.1-0.6-0.2-0.7L26.2,2
			C26.1,1.9,26,1.8,25.8,1.8z"
			/>
			<polygon
				id="XMLID_18_"
				fill="#D9D7CA"
				points="26.2,1.9 26.2,9.6 33.9,9.6 "
			/>
			<path
				id="XMLID_12_"
				fill="#CC4B4C"
				d="M14.5,23.5L14.5,23.5c-0.2,0-0.4-0.1-0.6-0.2c-0.7-0.5-0.8-1.1-0.7-1.5
			...
			<g id="XMLID_1_">
				<path
					id="XMLID_2_"
					fill="#CC4B4C"
					d="M15,30.9c-0.1-0.1-0.2-0.2-0.4-0.3c-0.2-0.1-0.4-0.1-0.7-0.1h-0.8v2.6h1c0.1,0,0.3,0,0.4-0.1
				c0.1,0,0.2-0.1,0.4-0.2c0.1-0.1,0.2-0.2,0.3-0.4c0.1-0.2,0.1-0.4,0.1-0.7c0-0.1,0-0.2,0-0.4C15.1,31.2,15,31.1,15,30.9z"
				/>
				<path
					id="XMLID_11_"
					fill="#CC4B4C"
					d="M21.1,31.2c-0.2-0.2-0.4-0.4-0.8-0.5s-0.7-0.2-1.2-0.2h-0.6v4.9h1.1c0.7,0,1.2-0.2,1.6-0.7
				s0.5-1.1,0.5-2c0-0.3,0-0.5-0.1-0.8C21.5,31.7,21.3,31.4,21.1,31.2z"
				/>
				<path
					id="XMLID_22_"
					fill="#CC4B4C"
					d="M6.1,27.1v10.1c0,0.5,0.4,0.9,0.9,0.9h26c0.5,0,0.9-0.4,0.9-0.9V27.1H6.1z M16,32.6
