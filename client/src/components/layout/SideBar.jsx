					...
					<nav aria-label="Tool Menu">
						<span title="Tool" className="nav-item-header">
							...
							<i><svg
								...
								viewBox="0 0 40 40">
								<path fill="#B3E8CD" d="M20,5L20,5C11.7,5,5,11.7,5,20h0c2.1-3.4,6.1-4.8,6.1-4.8s1.1,2.7,3.4,4.8h0
									c0-1.2,0.5-2.3,1.2-3.3c1-1.3,2.5-2.2,4.3-2.2l0,0c2.1-2.3,4.8-4.1,4.8-4.1S23.4,7.1,20,5z"/>
								<path fill="#FFF4A4" d="M20,25.4c-1.2,0-2.3-0.5-3.3-1.2h0c-1.3-1-2.2-2.5-2.2-4.3l0,0v0c0,0,0,0,0,0h0
								...
								<path fill="#FF99CC" d="M20,25.4L20,25.4c-2.1,2.3-4.8,4.1-4.8,4.1s1.4,3.4,4.8,5.5c8.3,0,15-6.7,15-15
						...
						<nav aria-label="Admin Menu">
							<span title="Admin Header" className="nav-item-header">
								...
								<i><svg
									...
									width="40px" height="40px"
									viewBox="0 0 40 40">
									<path fill="#BDCCD4" d="M35.5,18.6c0-0.4-0.3-0.7-0.6-0.9l-3-1.8c-0.1-0.2-0.2-0.5-0.3-0.7
									...
									<path fill="none" stroke="#3F4344" strokeWidth="1.5" strokeMiterlimit="10" d="M32.2,28.9l-0.9-3.4
